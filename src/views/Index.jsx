...
export default function Index() {
  return (
    <>
      <section className="bg-off-white1 dark:bg-blue3 min-h-screen flex items-center justify-center pt-10 pb-10 px-4 overflow-x-hidden font-helvetica">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-y-4 gap-x-4 sm:gap-y-6 sm:gap-x-6 grid-flow-row-dense content-center justify-center">
          ...
          <div className="bg-blue3 text-black rounded-xl col-span-2 h-36 w-full sm:w-80 shadow-4xl dark:shadow-none border-0 dark:border-4 dark:border-off-white2"><SearchBox /></div>
          ...
          <div className="hidden sm:block overflow-hidden rounded-xl col-span-3 row-span-2 h-80 shadow-4xl dark:shadow-none "><Windy /></div>
          ...
          <div className="bg-[#000000] rounded-xl col-span-2 row-span-2 h-80 sm:h-auto shadow-4xl dark:shadow-none border-0 dark:border-4 dark:border-off-white2"><SolarGraph /></div>
